...
# basic tests to review code above
# print()
# print(squares)
# print(unitlist)
# print()
...
def test():
    """A set of tests for def cross(A,B) set up that must pass."""
...
def grid_values(grid):
    """Convert grid into a dict of {square: char} with '0'
...
# eliminate d2 from the peers.
    ...
    # Contradiction: removed last value
        ...
        if not all(eliminate(values, s2, d2) for s2 in peers[s]):
            return False
# Attempt at implenting the naked twin strategy
#    elif len(values[s]) == 2:
#        d2 = values[s]
#        if not all(eliminate(values, s2, d2) for s2 in peers[s]):
#            return False
